...
Command: npx gltfjsx@6.2.10 public/characters/dj/dj.gltf 
*/
...
const Dj = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("./characters/dj/dj.gltf");
...
export default Dj;
useGLTF.preload("./characters/dj/dj.gltf");
